...
CLEAN_ALL_TABLES_SHELL_COMMAND = DB_SCRIPTS_PATH + "/WipeData.sh mode 5"
...
ADD_USER_CRANE_COMMAND = "cacctmgr add account -N=SubTestAccount -P=MainTestAccount -D=test"
